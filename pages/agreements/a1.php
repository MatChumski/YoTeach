...
if (isset($_SESSION["user_id"])) {
    ...
    $agreements = getNotFinishedAgreements($conn, $user_id, "1");
}
?>
...
<div class="container plus">
    <div class="content">
        ...
        <div class='menu'>
            <div class='sidebar'>
                <div>
                    <a href="a1.php" class='sidebarButton active'>Active</a>
                ...
                <form action='/yoteach/index.php' method='POST'>
                    <button type='submit' formaction='a1.php' class='sidebarButton active'>Active</button>
            ...
            if ($agreements) {
                ...
                echo "<div class='table'>You don't have any active agreements</div>";
            }
            ?>
